...
public class RandomValidateCodeUtil {
	...
	public static void getRandcode(HttpServletRequest request,
			HttpServletResponse response, String validateCodeKey) {
		...
		session.removeAttribute(validateCodeKey);
		session.setAttribute(validateCodeKey, randomString.toLowerCase());
